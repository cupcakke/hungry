...
class Customer(Base, TimestampMixin, SoftDeleteMixin, MetadataMixin):
    ...
    invoice_settings_custom_fields: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    invoice_settings_footer: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    invoice_settings_rendering_options: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    tax_ids: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_customers_next_invoice_sequence_positive",
        ),
    )
...
class PaymentIntent(Base, TimestampMixin, SoftDeleteMixin, MetadataMixin):
    ...
    amount_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    automatic_payment_methods: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    charges: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    ...
    description: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    last_payment_error: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    payment_method_configuration_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    payment_method_options: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    payment_method_types: Mapped[List[str]] = mapped_column(
        ARRAY(String),
        default=lambda: ["card"],
        nullable=False,
    )
    processing: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    transfer_data: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint("amount >= 0", name="ck_payment_intents_amount_nonnegative"),
        CheckConstraint(
            "amount_capturable >= 0",
            name="ck_payment_intents_amount_capturable_nonnegative",
        ),
        CheckConstraint(
            "amount_received >= 0",
            name="ck_payment_intents_amount_received_nonnegative",
        ),
    )
...
class Charge(Base, TimestampMixin, SoftDeleteMixin, MetadataMixin):
    ...
    billing_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    fraud_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    payment_method: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    payment_method_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    radar_options: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    receipt_email: Mapped[Optional[str]] = mapped_column(String(254), nullable=True)
    ...
    refunds: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    review: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    shipping_address_line1: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    shipping_address_line2: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    shipping_address_city: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint("amount >= 0", name="ck_charges_amount_nonnegative"),
        CheckConstraint(
            "amount_captured >= 0",
            name="ck_charges_amount_captured_nonnegative",
        ),
        CheckConstraint(
            "amount_refunded >= 0",
            name="ck_charges_amount_refunded_nonnegative",
        ),
        CheckConstraint(
            "amount_captured <= amount",
            name="ck_charges_amount_captured_not_excessive",
        ),
        CheckConstraint(
            "amount_refunded <= amount_captured",
            name="ck_charges_amount_refunded_not_excessive",
        ),
    )
...
class Refund(Base, TimestampMixin, SoftDeleteMixin, MetadataMixin):
    ...
    status: Mapped[str] = mapped_column(String(20), default="pending", nullable=False)
    status_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
...
class Subscription(Base, TimestampMixin, SoftDeleteMixin, MetadataMixin):
    ...
    automatic_tax: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    billing_cycle_anchor: Mapped[int] = mapped_column(BigInteger, nullable=False)
    billing_thresholds: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    cancellation_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    default_payment_method: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    default_source: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    default_tax_rates: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    description: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    discount: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    discounts: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    ended_at: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    invoice_settings: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    items: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    ...
    on_behalf_of: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    pause_collection: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    payment_settings: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    pending_invoice_item_interval: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    pending_setup_intent: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    pending_update: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    trial_settings: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint("quantity >= 1", name="ck_subscriptions_quantity_positive"),
        CheckConstraint(
            "days_until_due >= 0",
            name="ck_subscriptions_days_until_due_nonnegative",
        ),
        CheckConstraint(
...
class Invoice(Base, TimestampMixin, SoftDeleteMixin, MetadataMixin):
    ...
    attempted_extensions: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    ...
    created: Mapped[int] = mapped_column(BigInteger, nullable=False)
    currency: Mapped[str] = mapped_column(String(3), nullable=False)
    custom_fields: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    customer_id: Mapped[Optional[str]] = mapped_column(
        String(50),
        ForeignKey("customers.id", ondelete="SET NULL"),
        nullable=True,
    ...
    customer_address: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    customer_shipping: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    customer_tax_exempt: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    customer_tax_ids: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    default_payment_method: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    default_source: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    default_tax_rates: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    description: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    ...
    from_invoice: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    last_finalization_error: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    latest_payment_intent: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    prepayment_credit_notes: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    quote_id: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    receipt_number: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    rendering_options: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    shipping_cost: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    shipping_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    starting_balance: Mapped[int] = mapped_column(BigInteger, default=0, nullable=False)
    statement_descriptor: Mapped[Optional[str]] = mapped_column(String(22), nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="draft", nullable=False)
    status_transitions: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    subscription_id: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    subscription_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    total_discount_amounts: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    total_excluding_tax: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    total_tax_amounts: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    transfer_data: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint("amount_due >= 0", name="ck_invoices_amount_due_nonnegative"),
        CheckConstraint("amount_paid >= 0", name="ck_invoices_amount_paid_nonnegative"),
        CheckConstraint(
            "amount_remaining >= 0",
            name="ck_invoices_amount_remaining_nonnegative",
        ),
        ...
        CheckConstraint(
            "attempt_count >= 0",
            name="ck_invoices_attempt_count_nonnegative",
        ),
        CheckConstraint(
...
class InvoiceItem(Base, TimestampMixin, MetadataMixin):
    ...
    proration_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    quantity: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    subscription_id: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    subscription_item: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    tax_rates: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    test_clock: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "period_end >= period_start",
            name="ck_invoice_items_period_order",
        ),
        CheckConstraint(
            "quantity IS NULL OR quantity >= 0",
            name="ck_invoice_items_quantity_nonnegative",
        ),
    )
...
class CheckoutSession(Base, TimestampMixin, MetadataMixin):
    ...
    after_expiration: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    consent_collection: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    created: Mapped[int] = mapped_column(BigInteger, nullable=False)
    currency: Mapped[Optional[str]] = mapped_column(String(3), nullable=True)
    currency_conversion: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    custom_fields: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    custom_text: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    customer_id: Mapped[Optional[str]] = mapped_column(
        String(50),
        ForeignKey("customers.id", ondelete="SET NULL"),
        nullable=True,
    ...
    customer_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    customer_email: Mapped[Optional[str]] = mapped_column(String(254), nullable=True)
    customer_tax_ids: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    discounts: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    expires_at: Mapped[int] = mapped_column(BigInteger, nullable=False)
    invoice_id: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    invoice_creation: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    phone_number_collection: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    shipping_address_collection: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    shipping_cost: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    shipping_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    shipping_options: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    ...
    tax_id_collection: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    total_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "amount_subtotal IS NULL OR amount_subtotal >= 0",
            name="ck_checkout_sessions_amount_subtotal_nonnegative",
        ),
        CheckConstraint(
            "amount_total IS NULL OR amount_total >= 0",
            name="ck_checkout_sessions_amount_total_nonnegative",
        ),
        CheckConstraint(
            "expires_at >= created",
            name="ck_checkout_sessions_expiration_order",
        ),
    )
...
class PaymentMethod(Base, TimestampMixin, MetadataMixin):
    ...
    acss_debit: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    affirm: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    afterpay_clearpay: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    alipay: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    au_becs_debit: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    bacs_debit: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    bancontact: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    billing_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    blik: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    card: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    card_present: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    cashapp: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    created: Mapped[int] = mapped_column(BigInteger, nullable=False)
    customer_id: Mapped[Optional[str]] = mapped_column(
        String(50),
        ForeignKey("customers.id", ondelete="CASCADE"),
    ...
    eps: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    fpx: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    giropay: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    grabpay: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ideal: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    interac_present: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    klarna: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    konbini: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    link: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    multibanco: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    oxxo: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    p24: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    paynow: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    paypal: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    pix: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    promptpay: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    radar_options: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    sepa_debit: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    sofort: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    type: Mapped[str] = mapped_column(String(30), nullable=False)
    us_bank_account: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    wechat_pay: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    zip: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
...
class Balance(Base, TimestampMixin):
    ...
    available: Mapped[List[Dict[str, Any]]] = mapped_column(JSONB, default=list, nullable=False)
    connect_reserved: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    instant_available: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    issuing: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    pending: Mapped[List[Dict[str, Any]]] = mapped_column(JSONB, default=list, nullable=False)
...
class BalanceTransaction(Base, TimestampMixin, MetadataMixin):
    ...
    fee_details: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_balance_transactions_availability_order",
        ),
    )
...
class Event(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "pending_webhooks >= 0",
            name="ck_events_pending_webhooks_nonnegative",
        ),
    )
...
class EventDelivery(Base, TimestampMixin):
    ...
    request_headers: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "attempt_number >= 1",
            name="ck_event_deliveries_attempt_number_positive",
        ),
        CheckConstraint(
            "duration_ms IS NULL OR duration_ms >= 0",
            name="ck_event_deliveries_duration_nonnegative",
        ),
        CheckConstraint(
            "response_status_code IS NULL OR "
            "(response_status_code >= 100 AND response_status_code <= 599)",
            name="ck_event_deliveries_response_status_code_valid",
        ),
    )
...
class Account(Base, TimestampMixin, SoftDeleteMixin, MetadataMixin):
    ...
    business_profile: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    controller: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    external_accounts: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    individual: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    requirements: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    settings: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    tos_acceptance: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
...
class Product(Base, TimestampMixin, SoftDeleteMixin, MetadataMixin):
    ...
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    marketing_features: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    name: Mapped[str] = mapped_column(String(250), nullable=False)
    package_dimensions: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint("updated >= created", name="ck_products_updated_order"),
    )
...
class Price(Base, TimestampMixin, SoftDeleteMixin, MetadataMixin):
    ...
    created: Mapped[int] = mapped_column(BigInteger, nullable=False)
    currency: Mapped[str] = mapped_column(String(3), nullable=False)
    currency_options: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    custom_unit_amount: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    tiers: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    tiers_mode: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    transform_quantity: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_prices_recurring_interval_count_positive",
        ),
        CheckConstraint(
            "unit_amount IS NULL OR unit_amount >= 0",
            name="ck_prices_unit_amount_nonnegative",
        ),
        CheckConstraint(
            "unit_amount_decimal IS NULL OR unit_amount_decimal >= 0",
            name="ck_prices_unit_amount_decimal_nonnegative",
        ),
    )
...
class Coupon(Base, TimestampMixin, MetadataMixin):
    ...
    applies_to: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    created: Mapped[int] = mapped_column(BigInteger, nullable=False)
    currency: Mapped[Optional[str]] = mapped_column(String(3), nullable=True)
    currency_options: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_coupons_amount_off_nonnegative",
        ),
        CheckConstraint(
            "percent_off IS NULL OR (percent_off >= 0 AND percent_off <= 100)",
            name="ck_coupons_percent_off_range",
        ),
        CheckConstraint(
            "duration_in_months IS NULL OR duration_in_months >= 1",
            name="ck_coupons_duration_in_months_positive",
        ),
        CheckConstraint(
        ...
        CheckConstraint(
            "redemption_count >= 0",
            name="ck_coupons_redemption_count_nonnegative",
        ),
        CheckConstraint(
            "times_redeemed >= 0",
            name="ck_coupons_times_redeemed_nonnegative",
        ),
    )
...
class PromotionCode(Base, TimestampMixin, MetadataMixin):
    ...
    customer_constraint: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    restrictions: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    times_redeemed: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "max_redemptions IS NULL OR max_redemptions >= 1",
            name="ck_promotion_codes_max_redemptions_positive",
        ),
        CheckConstraint(
            "min_amount IS NULL OR min_amount >= 0",
            name="ck_promotion_codes_min_amount_nonnegative",
        ),
        CheckConstraint(
            "times_redeemed >= 0",
            name="ck_promotion_codes_times_redeemed_nonnegative",
        ),
    )
...
class Dispute(Base, TimestampMixin, MetadataMixin):
    ...
    amount: Mapped[int] = mapped_column(BigInteger, nullable=False)
    balance_transactions: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    charge_id: Mapped[str] = mapped_column(
        String(50),
        ForeignKey("charges.id", ondelete="CASCADE"),
        nullable=False,
    ...
    status: Mapped[str] = mapped_column(String(30), default="needs_response", nullable=False)

    __table_args__ = (
        Index("ix_disputes_status", "status"),
        Index("ix_disputes_charge", "charge_id"),
        CheckConstraint("amount >= 0", name="ck_disputes_amount_nonnegative"),
    )
...
class Payout(Base, TimestampMixin, MetadataMixin):
    ...
    created: Mapped[int] = mapped_column(BigInteger, nullable=False)
    currency: Mapped[str] = mapped_column(String(3), nullable=False)
    debit_from: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    description: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    destination: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    failure_balance_transaction: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    failure_code: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    ...
    statement_descriptor: Mapped[Optional[str]] = mapped_column(String(22), nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="pending", nullable=False)
    terminal_refund: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_payouts_arrival_date_order",
        ),
    )
...
class Transfer(Base, TimestampMixin, MetadataMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint("amount >= 0", name="ck_transfers_amount_nonnegative"),
        CheckConstraint(
            "amount_reversed >= 0",
            name="ck_transfers_amount_reversed_nonnegative",
        ),
        CheckConstraint(
            "amount_reversed <= amount",
            name="ck_transfers_amount_reversed_not_excessive",
        ),
    )
...
class TaxRate(Base, TimestampMixin, MetadataMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_tax_rates_percentage_range",
        ),
    )
...
class TaxId(Base, TimestampMixin):
    ...
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    owner: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    type: Mapped[str] = mapped_column(String(30), nullable=False)
...
class SetupIntent(Base, TimestampMixin, MetadataMixin):
    ...
    last_setup_error: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
...
class Mandate(Base, TimestampMixin, MetadataMixin):
    ...
    account_id: Mapped[Optional[str]] = mapped_column(String(50), nullable=True, index=True)
    customer_acceptance: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    multi_use: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    on_behalf_of: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    payment_method: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    payment_method_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    single_use: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
...
class CreditNote(Base, TimestampMixin, MetadataMixin):
    ...
    discount_amounts: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    effective_at: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint("amount >= 0", name="ck_credit_notes_amount_nonnegative"),
        CheckConstraint(
            "discount_amount >= 0",
            name="ck_credit_notes_discount_amount_nonnegative",
        ),
...
class ApplicationFee(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint("amount >= 0", name="ck_application_fees_amount_nonnegative"),
        CheckConstraint(
            "amount_refunded >= 0",
            name="ck_application_fees_amount_refunded_nonnegative",
        ),
        CheckConstraint(
            "amount_refunded <= amount",
            name="ck_application_fees_amount_refunded_not_excessive",
        ),
    )
...
class File(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "expires_at IS NULL OR expires_at >= created",
            name="ck_files_expiration_order",
        ),
    )
...
class Report(Base, TimestampMixin):
    ...
    __table_args__ = (
        CheckConstraint("updated >= created", name="ck_reports_updated_order"),
    )
...
class ReportRun(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "succeeded_at IS NULL OR succeeded_at >= created",
            name="ck_report_runs_succeeded_at_order",
        ),
    )
...
class Cardholder(Base, TimestampMixin, MetadataMixin):
    ...
    requirements: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    spending_controls: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="active", nullable=False)
    type: Mapped[str] = mapped_column(String(20), nullable=False)
...
class IssuingCard(Base, TimestampMixin, MetadataMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "exp_month >= 1 AND exp_month <= 12",
            name="ck_issuing_cards_exp_month_range",
        ),
        CheckConstraint(
            "exp_year >= 0",
            name="ck_issuing_cards_exp_year_nonnegative",
        ),
    )
...
class IssuingAuthorization(Base, TimestampMixin, MetadataMixin):
    ...
    merchant_data: Mapped[Dict[str, Any]] = mapped_column(JSONB, nullable=False)
    ...
    pending_request: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    request_history: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    status: Mapped[str] = mapped_column(String(20), default="pending", nullable=False)
    transactions: Mapped[Optional[List[str]]] = mapped_column(ARRAY(String), nullable=True)
    treasury: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "network_risk_score IS NULL OR network_risk_score >= 0",
            name="ck_issuing_authorizations_network_risk_score_nonnegative",
        ),
    )
...
class IssuingTransaction(Base, TimestampMixin, MetadataMixin):
    ...
    merchant_data: Mapped[Dict[str, Any]] = mapped_column(JSONB, nullable=False)
    merchant_name: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    purchase_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    treasury: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    type: Mapped[str] = mapped_column(String(30), nullable=False)
...
class FinancialAccount(Base, TimestampMixin, MetadataMixin):
    ...
    balance_cash: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    balance_inbound_pending: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    balance_outbound_pending: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    created: Mapped[int] = mapped_column(BigInteger, nullable=False)
    financial_addresses: Mapped[Optional[List[Dict[str, Any]]]] = mapped_column(JSONB, nullable=True)
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    status: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    status_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    submitted: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
...
class TreasuryTransaction(Base, TimestampMixin):
    ...
    account_id: Mapped[Optional[str]] = mapped_column(String(50), nullable=True, index=True)
    amount: Mapped[Dict[str, Any]] = mapped_column(JSONB, nullable=False)
    balance_impact: Mapped[Dict[str, Any]] = mapped_column(JSONB, nullable=False)
    created: Mapped[int] = mapped_column(BigInteger, nullable=False)
    ...
    flow_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "posted_at IS NULL OR posted_at >= created",
            name="ck_treasury_transactions_posted_at_order",
        ),
    )
...
class CapitalOffer(Base, TimestampMixin, MetadataMixin):
    ...
    created: Mapped[int] = mapped_column(BigInteger, nullable=False)
    currency: Mapped[str] = mapped_column(String(3), nullable=False)
    disbursement_method: Mapped[Dict[str, Any]] = mapped_column(JSONB, nullable=False)
    ...
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    payable_over: Mapped[Dict[str, Any]] = mapped_column(JSONB, nullable=False)
    ...
    __table_args__ = (
        ...
        CheckConstraint("amount >= 0", name="ck_capital_offers_amount_nonnegative"),
        CheckConstraint(
            "fee_amount >= 0",
            name="ck_capital_offers_fee_amount_nonnegative",
        ),
        CheckConstraint(
            "fee_percent >= 0",
            name="ck_capital_offers_fee_percent_nonnegative",
        ),
        CheckConstraint(
            "interest_rate >= 0",
            name="ck_capital_offers_interest_rate_nonnegative",
        ),
        CheckConstraint(
            "total_amount >= amount",
            name="ck_capital_offers_total_amount_valid",
        ),
    )
...
class VerificationSession(Base, TimestampMixin, MetadataMixin):
    ...
    provided_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    redaction: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    status: Mapped[str] = mapped_column(String(30), default="requires_input", nullable=False)
    type: Mapped[str] = mapped_column(String(30), nullable=False)
    url: Mapped[Optional[str]] = mapped_column(String(500), nullable=True)
    verified_outputs: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
...
class Review(Base, TimestampMixin):
    ...
    email: Mapped[Optional[str]] = mapped_column(String(254), nullable=True)
    ip_address: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
    ip_address_location: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    livemode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    ...
    session: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
...
class Order(Base, TimestampMixin, MetadataMixin):
    ...
    tax_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    total_details: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "amount_subtotal >= 0",
            name="ck_orders_amount_subtotal_nonnegative",
        ),
        CheckConstraint(
            "amount_total >= 0",
            name="ck_orders_amount_total_nonnegative",
        ),
        CheckConstraint(
            "amount_captured IS NULL OR amount_captured >= 0",
            name="ck_orders_amount_captured_nonnegative",
        ),
        CheckConstraint(
            "amount_returned IS NULL OR amount_returned >= 0",
            name="ck_orders_amount_returned_nonnegative",
        ),
    )
...
class OrderItem(Base, TimestampMixin):
    ...
    product: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    quantity: Mapped[int] = mapped_column(Integer, default=1, nullable=False)
    type: Mapped[str] = mapped_column(String(20), nullable=False)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "amount_discount >= 0",
            name="ck_order_items_amount_discount_nonnegative",
        ),
        CheckConstraint(
            "amount_subtotal >= 0",
            name="ck_order_items_amount_subtotal_nonnegative",
        ),
        CheckConstraint(
            "amount_tax >= 0",
            name="ck_order_items_amount_tax_nonnegative",
        ),
        CheckConstraint(
            "amount_total >= 0",
            name="ck_order_items_amount_total_nonnegative",
        ),
        CheckConstraint(
            "quantity >= 1",
...
class SubscriptionItem(Base, TimestampMixin, MetadataMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "quantity >= 1",
            name="ck_subscription_items_quantity_positive",
        ),
    )
...
class UsageRecord(Base, TimestampMixin):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "period_end >= period_start",
            name="ck_usage_records_period_order",
        ),
    )
...
class IdempotencyKey(Base, TimestampMixin):
    ...
    request_raw_params: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    response_body: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    response_headers: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSONB, nullable=True)
    response_status_code: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "response_status_code IS NULL OR "
            "(response_status_code >= 100 AND response_status_code <= 599)",
            name="ck_idempotency_keys_response_status_code_valid",
        ),
    )
